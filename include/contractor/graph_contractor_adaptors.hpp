...
std::vector<ContractorEdge> ContractorEdgeInputAdaptor(InputEdgeContainer input_edge_list)
{
    ...
    {
#ifndef NDEBUG
        if (static_cast<unsigned int>(std::max(input_edge.weight, 1)) > 24 * 60 * 60 * 10)
        {
